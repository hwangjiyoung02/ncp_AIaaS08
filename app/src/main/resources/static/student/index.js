    ...
    .then((result) => {
      ...
      if (student.photo) {
        document.querySelector(
          "#f-photo-origin"
        ).href = `https://kr.object.ncloudstorage.com/ncp-ai08-bucket-1117-member-photo/${student.photo}`;
        document.querySelector(
          "#f-photo"
        ).src = `https://ltwnnyna4719.edge.naverncp.com/Di7fzaHNV4/${student.photo}?type=f&w=80&h=80&faceopt=true&ttype=jpg`;
      } /*else {
        document.querySelector("#f-photo").src = "../images/no-body.webp";
      }*/

      S
      //student.photo=icando.jp
      // https://ltwnnyna4719.edge.naverncp.com/Di7fzaHNV4/icando.jpg?type=f&w=80&h=80&faceopt=true&ttype=jpg
